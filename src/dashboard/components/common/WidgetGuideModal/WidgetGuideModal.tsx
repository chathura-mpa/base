...
import classes from './WidgetGuideModal.module.scss'
...
const WidgetGuideModal: React.FC<WidgetGuideModalProps> = ({ onModalClosed, isModalOpened }) => {
  ...
  const STEP_CARDS: StepCardProps[] = [
    ...
    {
      image: step2Image,
      title: 'Step 2 | Adding the Auction Store Plugin',
      explain: "We'll now add the Auction Store plugin to the product page.",
      steps: [
        ...
        <span key="step2-plugin-card">Find Auction Store Plugin Card {_renderMiniImages(iconAppLogo)}.</span>,
